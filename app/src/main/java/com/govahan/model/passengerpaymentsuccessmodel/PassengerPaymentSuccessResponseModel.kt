package com.govahan.model.passengerpaymentsuccessmodel
...
data class PassengerPaymentSuccessResponseModel (
    ...
    @SerializedName("Owner"    ) var Owner    : PassengerPaymentSuccessOwner?   = PassengerPaymentSuccessOwner(),
...
)data class PassengerPaymentSuccessOwner (
    @SerializedName("name"          ) var name         : String? = null,
    @SerializedName("email"         ) var email        : String? = null,
    @SerializedName("mobile_number" ) var mobileNumber : String? = null
)
