package com.govahan.model.searchPassengerVehicle
...
data class SearchPassengerData (
    ...
    @SerializedName("pickup_location"  ) var picupLocation  : String? = null,
    ...
    @SerializedName("distance_search"       ) var distance_search      : Float? = null,
