package com.govahan.model.completedpassengertriphistorymodel
...
data class CompletedPassengerTripHistoryResponseModel (

    @SerializedName("status"  ) var status  : Int?            = null,
    @SerializedName("message" ) var message : String?         = null,
    @SerializedName("data"    ) var data    : ArrayList<CompletedPassengerHistoryData> = arrayListOf()

)@Parcelize



data class CompletedPassengerHistoryData (
