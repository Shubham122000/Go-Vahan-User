...
import com.govahan.activities.HomeActivity
import java.util.*
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        if (remoteMessage.data != null){
            Log.d(TAG, "Objects: " + remoteMessage.data);
            generateNotification(this,remoteMessage.data.toString())
        }
    }
