package com.govahan.activities.auth.login
...
import com.govahan.databinding.ActivityLoginBinding
import com.govahan.databinding.DialogOtpBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnLogin.setOnClickListener {
            ...
            if (binding.etMobileNumber.text.toString().trim() == "" || binding.etMobileNumber.text.toString().trim().length <  10){
                ...
                viewModel.userLogin(binding.etMobileNumber.text.toString().trim(),"Android","Android","Android",token,binding.referralCode.text.toString())
            }
        }
        ...
        object : CountDownTimer(60000, 1000) {
            override fun onTick(millisUntilFinished: Long) {
                if(millisUntilFinished / 1000<10){
                    dialogOtpBinding.timer.setText("00:0" + millisUntilFinished / 1000)
                }else{
                    dialogOtpBinding.timer.setText("00:" + millisUntilFinished / 1000)

                }
                dialogOtpBinding.tvResend.isEnabled = false
                dialogOtpBinding.tvResend.visibility=View.GONE

            }

            override fun onFinish() {
                dialogOtpBinding.timer.setText("00:00")
                dialogOtpBinding.tvResend.isEnabled = true
                dialogOtpBinding.tvResend.visibility=View.VISIBLE
            }
        }.start()
