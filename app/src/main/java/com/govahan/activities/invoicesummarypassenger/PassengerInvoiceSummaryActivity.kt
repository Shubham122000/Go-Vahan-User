package com.govahan.activities.invoicesummarypassenger
...
import com.govahan.databinding.ActivityPassengerInvoiceSummaryBinding
...
//                binding.tvCompleteDate.text = it.data[0].bookingDate
                    ...
                    binding.tvTotalamount.text = "₹${it.data[0].freight_amount}"
