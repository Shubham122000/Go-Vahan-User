package com.govahan.activities.passengerOngoingBookingDetails
...
@HiltViewModel
class PassengerOngoingBookingDetailsViewModel   @Inject constructor(private val mainRepository: MainRepository, private val utils : Utils, @ApplicationContext val context: Context) : ViewModel(){

    val passengerOngoingHistoryDetailResponse = MutableLiveData<PassengerOngoingHistoryDetailResponseModel>()
...
//                Log.d("TAG", response.body().toString())
                passengerOngoingHistoryDetailResponse.postValue(response.body())
            } else {
                progressBarStatus.value = false
                Log.d("TAG", response.body().toString())
            }
