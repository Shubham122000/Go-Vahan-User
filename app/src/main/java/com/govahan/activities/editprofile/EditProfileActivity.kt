package com.govahan.activities.editprofile
...
import com.govahan.util.CommonUtils
import com.govahan.util.toast
import com.govahanpartner.com.permission.RequestPermission
import com.govahan.databinding.ActivityEditProfileBinding
...
//                userPref.user = it.data!!
                ...
                if (it.data!!.profile_image != null) {
                    userPref.setProfileImage(it.data!!.profile_image)
                ...
                photoFile?.also {
                    val photoURI: Uri =
                        FileProvider.getUriForFile(
                            this,
                            "com.govahan.myUniquefileprovider",
                            it
                        )
...
//                    }
    ...
    private fun openSettings() {
        ...
        val uri = Uri.fromParts("package", "com.govahan", null)
        intent.data = uri
