...
class CancelledPassengerTripHistoryAdapter (val list: List<CancelledPassengerTripHistoryData>,
...
) : RecyclerView.Adapter<CancelledPassengerTripHistoryAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.linearItem.setOnClickListener(View.OnClickListener {
            ...
            listener.onCancelledPassDetailClicked(data)
    ...
    interface OnClick{
        fun onCancelledPassDetailClicked(cancelledPassengerTripHistoryData: CancelledPassengerTripHistoryData)
    }
