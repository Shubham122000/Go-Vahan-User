package com.govahanuser.com.model.tripmanagementpassengermodel

import android.os.Parcelable
import com.google.gson.annotations.SerializedName
import kotlinx.parcelize.Parcelize

data class PassengerTripManagementResponseModel (

    @SerializedName("status"  ) var status  : Int?            = null,
    @SerializedName("message" ) var message : String?         = null,
    @SerializedName("data"    ) var data    : ArrayList<PassengerTripManagementData> = arrayListOf()


)@Parcelize

data class PassengerTripManagementData (
