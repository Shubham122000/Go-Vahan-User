package com.govahanuser.com.model.ongoingPassengerTripHistoryModel
...
data class OngoingPassengerTripHistoryResponseModel (

    @SerializedName("status"  ) var status  : Int?            = null,
    @SerializedName("message" ) var message : String?         = null,
    @SerializedName("data"    ) var data    : ArrayList<OngoingPassengerHistoryData> = arrayListOf()

)@Parcelize

data class OngoingPassengerHistoryData (
