package com.govahanuser.com.model.ongoingloadertriphistorymodel

import android.os.Parcelable
import com.google.gson.annotations.SerializedName
import kotlinx.parcelize.Parcelize

data class OngoingLoaderTripHistoryResponseModel (

    @SerializedName("status"  ) var status  : Int?            = null,
    @SerializedName("message" ) var message : String?         = null,
    @SerializedName("data"    ) var data    : ArrayList<OngoingLoaderHistoryData> = arrayListOf()

)@Parcelize

data class OngoingLoaderHistoryData (
