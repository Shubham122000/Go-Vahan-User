package com.govahanuser.com.model.completedloadertriphistorymodel
...
data class CompletedLoaderTripHistoryResponseModel (

    @SerializedName("status"  ) var status  : Int?            = null,
    @SerializedName("message" ) var message : String?         = null,
    @SerializedName("data"    ) var data    : ArrayList<CompletedLoaderHistoryData> = arrayListOf()

)@Parcelize


data class CompletedLoaderHistoryData (
