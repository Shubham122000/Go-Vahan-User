package com.govahanuser.com.model.cancelledloadertriphistorymodel

import android.os.Parcelable
import com.google.gson.annotations.SerializedName
import kotlinx.parcelize.Parcelize

data class CancelledLoaderTripHistoryResponseModel (

    @SerializedName("status"  ) var status  : Int?            = null,
    @SerializedName("message" ) var message : String?         = null,
    @SerializedName("data"    ) var data    : ArrayList<CancelledLoaderTripHistoryData> = arrayListOf()

)@Parcelize

data class CancelledLoaderTripHistoryData (
